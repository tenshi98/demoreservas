...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class unidadesListado extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'unidadesListado';
    ...
    public function listAll($f3){
        /*******************************************************************/
        //Se genera la query
        $arrList = $this->getDataList('idUnidades!=0');
        ...
        if($arrList['status']){
            ...
            $f3->data = [
                ...
                'PageDescription' => 'Listado Unidades.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Listado de Unidades',
                /*===========  Datos del usuario ===========*/
    ...
    public function UpdateList($f3){
        ...
        $whereInt = $this->searchWhere($whereInt, $WhereData_int, 'unidades_listado', 1);
        $whereInt = $this->searchWhere($whereInt, $WhereData_string, 'unidades_listado', 2);
        $whereInt = $this->searchWhere($whereInt, $WhereData_between, 'unidades_listado', 3);
