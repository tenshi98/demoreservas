...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class estadosInstaller extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'estadosInstaller';
    ...
    public function ListDataModule(){
        ...
        $arrData = [
            ...
            'Descripcion'   => 'Módulo para gestionar los Estados',
    ...
    public function InstallModule(){
        ...
        $arrPermisos[] = [
            ...
            'idEstado'       => '1',
            'idTipo'         => '1',
            'Nombre'         => 'Estados - Listado',
            'Descripcion'    => 'Permite la administracion de los Estados de las Reservas',
            'idLevelLimit'   => '4',
            'RutaWeb'        => 'mantencion/estados/listado',
            'RutaController' => 'estadosListado',
        ];
        /************************************************/
        /************************************************/
        //Verifico si existe
    ...
    public function UninstallModule(){
        ...
        /*******************************************************/
        $arrTableDel  = array();
        $arrTableDel[] = ['table' => 'estados_listado'];
    ...
    public function listRouteModule($Type, $permisosID){
        ...
        switch ($Type) {
            /******************************************/
            case 1:
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 1, 'RutaWeb' => 'mantencion/estados/listado/listAll',      'RutaController' => 'estadosListado->listAll',      'Descripcion' => 'Listar Toda la Información',                     'idLevelLimit' => 1, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 2, 'RutaWeb' => 'mantencion/estados/listado/search',       'RutaController' => 'estadosListado->UpdateList',   'Descripcion' => 'Filtrar datos',                                  'idLevelLimit' => 1, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 1, 'RutaWeb' => 'mantencion/estados/listado/updateList',   'RutaController' => 'estadosListado->UpdateList',   'Descripcion' => 'Actualizar Lista',                               'idLevelLimit' => 2, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 1, 'RutaWeb' => 'mantencion/estados/listado/view/@id',     'RutaController' => 'estadosListado->View',         'Descripcion' => 'Mostrar Detallado',                              'idLevelLimit' => 1, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 1, 'RutaWeb' => 'mantencion/estados/listado/getID/@id',    'RutaController' => 'estadosListado->GetID',        'Descripcion' => 'Información para el formulario edición',         'idLevelLimit' => 2, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 2, 'RutaWeb' => 'mantencion/estados/listado',              'RutaController' => 'estadosListado->Insert',       'Descripcion' => 'Crear Información',                              'idLevelLimit' => 3, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 2, 'RutaWeb' => 'mantencion/estados/listado/update',       'RutaController' => 'estadosListado->Update',       'Descripcion' => 'Editar por post (modificar y subir archivos)',   'idLevelLimit' => 2, 'Controller' => 'estadosListado'];
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 3, 'RutaWeb' => 'mantencion/estados/listado',              'RutaController' => 'estadosListado->Delete',       'Descripcion' => 'Borrar dato y archivos',                         'idLevelLimit' => 4, 'Controller' => 'estadosListado'];
