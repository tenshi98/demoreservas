...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class estadosListado extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'estadosListado';
    ...
    public function listAll($f3){
        /*******************************************************************/
        //Se genera la query
        $arrList = $this->getDataList('idEstadoReserva!=0');
        ...
        if($arrList['status']){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'PageTitle'       => 'Listado Estados',
                'PageDescription' => 'Listado Estados.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Listado de Estados',
                /*===========  Datos del usuario ===========*/
    ...
    public function UpdateList($f3){
        ...
        $whereInt = $this->searchWhere($whereInt, $WhereData_int, 'estados_listado', 1);
        $whereInt = $this->searchWhere($whereInt, $WhereData_string, 'estados_listado', 2);
        $whereInt = $this->searchWhere($whereInt, $WhereData_between, 'estados_listado', 3);
