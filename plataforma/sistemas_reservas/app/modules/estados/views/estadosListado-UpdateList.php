        ...
        if(is_array($data['arrList'])&&!empty($data['arrList'])){
            ...
            foreach($data['arrList'] as $crud){
                ...
                <tr>
                    ...
                    <td><?php echo '<span class="badge-sp1 badge-sp1-bg-info" style="background-color: '.$crud['ColorClaro'].';color: '.$crud['Color'].'; border: 1px solid '.$crud['Color'].';">'.$crud['Nombre'].'</span>';?></td>
                    <td>
