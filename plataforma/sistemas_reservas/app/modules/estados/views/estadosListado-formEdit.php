...
<form id="FormEditData" name="FormEditData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data" aria-label="Formulario de ejecucion">
    ...
    <div class="modal-body">
        ...
        $data['Fnc_FormInputs']->formInput(['FormType' => 12, 'Placeholder' => 'Color',  'Name' => 'Color',   'Id' => 'Edit_Color',   'Value' => ($data['rowData']['Color'] ?? ''),  'Required' => 2,'InputClass'  => 'form-control-color', 'Icon' => 'bi bi-palette']);

        //datos ocultos
        $data['Fnc_FormInputs']->formInputHidden(['Name' => 'idEstadoReserva','Value' => $data['rowData']['idEstadoReserva'],'Required' => 2]);
        ?>
    </div>
