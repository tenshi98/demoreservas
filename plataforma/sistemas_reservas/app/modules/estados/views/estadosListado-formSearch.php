        ...
        <div class="container well">
            <div class="row">
                <div class="col align-self-center">
                    ...
                    $data['Fnc_FormInputs']->formInput(['FormType' => 12, 'Placeholder' => 'Color',  'Name' => 'Color',   'Id' => 'Search_Color',   'Value' => '', 'Required' => 1,'InputClass'  => 'form-control-color', 'Icon' => 'bi bi-palette']);
