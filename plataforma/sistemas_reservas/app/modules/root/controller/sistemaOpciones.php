...
class sistemaOpciones extends ControllerBase {
    ...
    public function Resumen($f3){
        ...
        /*******************************************************************/
        //Si hay resultados
        if($rowData['status'] && $arrCiudad['status'] && $arrComuna['status'] && $arrTemas['status'] && $arrConfigEmail['status'] && $arrConfigMap['status']){
            /******************************************/
        ...
        //si no hay resultados
            ...
            $result = $this->mergeResponses([$rowData,$arrCiudad,$arrComuna,$arrTemas,$arrConfigEmail,$arrConfigMap]);
            //Muestra los errores
