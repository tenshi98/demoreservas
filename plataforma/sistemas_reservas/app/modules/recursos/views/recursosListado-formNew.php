        ...
        <div class="modal-content">
            <form id="FormNewData" name="FormNewData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data" aria-label="Formulario de ejecucion">
                ...
                <div class="modal-body">
                    ...
                    $data['Fnc_FormInputs']->formSelect([                 'Placeholder' => 'Tipo de Cobro', 'Name' => 'idTipoCobro',  'Value' => '', 'Required' => 2,'arrData' => $data['arrTipoCobro']]);
                    $data['Fnc_FormInputs']->formInput(['FormType' => 5,  'Placeholder' => 'Valor',         'Name' => 'Valor',        'Value' => '', 'Required' => 1,'Icon' => 'bi bi-currency-dollar']);
...
<script>
    ...
    //cargo
    document.getElementById("idTipoCobro").onchange = function() {cngFnc_idTipoCobro()}
    //Ejecutar logica
    function cngFnc_idTipoCobro() {
        //obtengo los valores
        let idTipoCobro = $("#idTipoCobro").val();
        //selecciono
        if (idTipoCobro != "") {
            //selecciono
            switch (idTipoCobro) {
