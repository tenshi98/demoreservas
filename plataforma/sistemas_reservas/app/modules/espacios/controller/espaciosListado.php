...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class espaciosListado extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'espaciosListado';
    ...
    public function listAll($f3){
        /*******************************************************************/
        //Se genera la query
        $arrList = $this->getDataList('espacios_listado.idEspacio!=0');
        ...
        if($arrList['status'] && $arrEstado['status'] && $arrCategoria['status']){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'PageTitle'       => 'Listado Espacios',
                'PageDescription' => 'Listado Espacios.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Listado de Espacios',
                /*===========  Datos del usuario ===========*/
    ...
    public function UpdateList($f3){
        ...
        $whereInt = $this->searchWhere($whereInt, $WhereData_int, 'espacios_listado', 1);
        $whereInt = $this->searchWhere($whereInt, $WhereData_string, 'espacios_listado', 2);
        $whereInt = $this->searchWhere($whereInt, $WhereData_between, 'espacios_listado', 3);
        //Verifico si esta vacio
        $whereInt2 = $whereInt ? $whereInt . ' AND espacios_listado.idEspacio!=0' : 'espacios_listado.idEspacio!=0';
    ...
    public function View($f3, $params){
        ...
        $query = [
            'data'    => '
                espacios_listado.idEspacio,
                espacios_listado.Nombre,
                espacios_listado.nMaxPersonas,
                core_estados.Nombre AS Estado,
                core_estados.Color AS EstadoColor,
                espacios_categorias.Nombre AS Categoria',
            'table'   => 'espacios_listado',
            'join'    => '
                LEFT JOIN core_estados          ON core_estados.idEstado              = espacios_listado.idEstado
                LEFT JOIN espacios_categorias   ON espacios_categorias.idCategoria    = espacios_listado.idCategoria',
            'where'   => 'espacios_listado.idEspacio = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
            'having'  => '',
            'order'   => ''
        ];
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idEspacio,idEstado,idCategoria,Nombre,nMaxPersonas',
            'table'   => 'espacios_listado',
            'join'    => '',
            'where'   => 'idEspacio = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
            'having'  => '',
            'order'   => ''
        ];
    ...
    private function getDataList($filter){
        ...
        $query = [
            ...
            'group'   => '',
            'having'  => '',
            'order'   => 'espacios_listado.idEstado ASC, espacios_categorias.Nombre ASC, espacios_listado.Nombre ASC',
            'limit'   => ConfigAPP::APP["N_MaxItems"]
        ];
        //Ejecuto la query
        $xParams = ['query' => $query];
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idEstado,idCategoria,Nombre,nMaxPersonas',
            'required'  => 'idEstado,idCategoria,Nombre,nMaxPersonas',
            'unique'    => 'Nombre',
            'encode'    => '',
            'table'     => 'espacios_listado',
            'Post'      => $_POST
    ...
    private function dataCheck($POST){
        ...
        $DataChecking = [
            ...
            'encode'                    => '',
            'ValidarEmail'              => '',
            'ValidarNumero'             => 'idEstado,idCategoria',
