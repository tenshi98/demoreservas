...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class espaciosCategorias extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'espaciosCategorias';
    ...
    public function listAll($f3){
        /*******************************************************************/
        //Se genera la query
        $arrList = $this->getDataList('idCategoria!=0');
        ...
        if($arrList['status']){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'PageTitle'       => 'Categorias Espacios',
                'PageDescription' => 'Categorias Espacios.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Categorias de Espacios',
                /*===========  Datos del usuario ===========*/
    ...
    public function UpdateList($f3){
        ...
        $whereInt = $this->searchWhere($whereInt, $WhereData_int, 'espacios_categorias', 1);
        $whereInt = $this->searchWhere($whereInt, $WhereData_string, 'espacios_categorias', 2);
        $whereInt = $this->searchWhere($whereInt, $WhereData_between, 'espacios_categorias', 3);
