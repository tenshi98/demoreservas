        ...
        <div class="modal-content">
            <form id="FormNewData" name="FormNewData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data" aria-label="Formulario de ejecucion">
                ...
                <div class="modal-body">
                    ...
                    $data['Fnc_FormInputs']->formSelectFilter([           'Placeholder' => 'Categoria',             'Name' => 'idCategoria',  'Value' => '', 'Required' => 2,'arrData' => $data['arrCategoria'], 'BASE' => $BASE]);
                    $data['Fnc_FormInputs']->formNumberSpinner([          'Placeholder' => 'N° Maximo de Personas', 'Name' => 'nMaxPersonas', 'Value' => '', 'Required' => 2,'Min' => 1,'Max' => 2000,'Step' => 1,'Ndecimal' => 0]);
