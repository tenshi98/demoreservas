...
<form id="FormEditData" name="FormEditData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data" aria-label="Formulario de ejecucion">
    ...
    <div class="modal-body">
        ...
        $data['Fnc_FormInputs']->formNumberSpinner([          'Placeholder' => 'N° Maximo de Personas', 'Name' => 'nMaxPersonas', 'Id' => 'Edit_nMaxPersonas',  'Value' => ($data['rowData']['nMaxPersonas'] ?? ''), 'Required' => 2,'Min' => 1,'Max' => 2000,'Step' => 1,'Ndecimal' => 0]);

        //datos ocultos
        $data['Fnc_FormInputs']->formInputHidden(['Name' => 'idEspacio','Value' => $data['rowData']['idEspacio'],'Required' => 2]);
        ?>
    </div>
