...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class solicitantesListadoObservaciones extends ControllerBase {
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idObservaciones,idSolicitante,Observacion,FechaCreacion',
            'table'   => 'solicitantes_listado_observaciones',
            'join'    => '',
            'where'   => 'idObservaciones = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idSolicitante,Observacion,FechaCreacion',
            'required'  => 'idSolicitante,Observacion,FechaCreacion',
            'unique'    => '',
            'encode'    => '',
            'table'     => 'solicitantes_listado_observaciones',
            'Post'      => $_POST
    ...
    public function Update(){
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $query = [
                'data'      => 'idObservaciones,idSolicitante,Observacion,FechaCreacion',
                'required'  => 'idSolicitante,Observacion',
                'unique'    => '',
                'encode'    => '',
                'table'     => 'solicitantes_listado_observaciones',
    ...
    private function dataCheck($POST){
        ...
        $DataChecking = [
            ...
            'encode'                    => '',
            'ValidarEmail'              => '',
            'ValidarNumero'             => 'idSolicitante',
            'ValidarEntero'             => 'idSolicitante',
            'ValidarRut'                => '',
            'ValidarPatente'            => '',
