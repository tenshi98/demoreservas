        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php require_once('solicitantesListado-formSearch.php'); ?>
                    <div class="clearfix"></div>
                    <div class="table-responsive" id="listTableData">
                        <?php require_once('solicitantesListado-UpdateList.php'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php require_once('solicitantesListado-formNew.php'); ?>
    ...
    function listTableDataDel(ID, Dato) {
        Swal.fire({
            ...
            if (result2.isConfirmed) {
                ...
                let Informacion = {"idSolicitante": ID};
                const Options     = {
                    UpdateDiv : [
