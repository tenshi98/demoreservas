...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class periodicidadListado extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'periodicidadListado';
    ...
    public function listAll($f3){
        /*******************************************************************/
        //Se genera la query
        $arrList = $this->getDataList('idPeriodicidad!=0');
        ...
        if($arrList['status']){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'PageTitle'       => 'Listado Periodicidad',
                'PageDescription' => 'Listado Periodicidad.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Listado de Periodicidad',
                /*===========  Datos del usuario ===========*/
    ...
    public function UpdateList($f3){
        ...
        $whereInt = $this->searchWhere($whereInt, $WhereData_int, 'periodicidad_listado', 1);
        $whereInt = $this->searchWhere($whereInt, $WhereData_string, 'periodicidad_listado', 2);
        $whereInt = $this->searchWhere($whereInt, $WhereData_between, 'periodicidad_listado', 3);
    ...
    public function View($f3, $params){
        ...
        $query = [
            ...
            'join'    => '',
            'where'   => 'idPeriodicidad = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
            'having'  => '',
            'order'   => ''
        ];
