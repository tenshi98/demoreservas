...
<section class="section dashboard" data-aos="fade-up" data-aos-delay="300" data-aos-offset="200" data-aos-duration="500">
    <div class="row">
        ...
        if(is_array($data['arrList'])&&!empty($data['arrList'])){
            ...
            $estadisticas = $data['Fnc_CommonData']->agruparYContar($data['arrList'], $dataRequired); ?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        <?php echo $data['TableTitle'].' (<strong>'.($estadisticas['totalElementos'] ?? 0).' Solicitudes</strong>)'; ?>
                    </h5>
