...
if(isset($data['UserData']['UserType'])&&$data['UserData']['UserType']==1){ ?>
    ...
    <button class="btn btn-outline-danger dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-list"></i> Plataforma</button>
    ...
    <button class="btn btn-outline-danger dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-list"></i> Maquetación</button>
    <ul class="dropdown-menu dropdown-menu-large dropdown-menu-large-arrow row">
